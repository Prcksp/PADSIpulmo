        ...
        <div class="card-body">
            <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="text" class="form-control" name="email" tabindex="1" value="{{ old('email') }}" required autocomplete="username" autofocus>
                ...
                @if($errors->any())
                    <div class="text-center p-t-12 text-danger">
                        <span class="txt2">
                            <p>Email atau kata sandi yang Anda masukkan salah!</p>
                        </span>
                    </div>
                @endif
            </form>
