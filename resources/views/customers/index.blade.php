                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ url('customers/create') }}" class="btn btn-icon btn-primary">
                                        ...
                                        @foreach ($customers as $customer)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('customers.destroy', ['customer' => $customer->id_customer]) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
